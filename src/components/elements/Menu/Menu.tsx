...
const Menu = ({MenuCards,setMenu}:setMenu) => {
    const menuItems = MenuCards.map((elem:{title:string,img:string,url:string},index:number) => <MenuCard url={elem.url} key={index} title={elem.title} img={elem.img} />)
        ...
        >
            ...
            <div className={styles.leftSide}>
                <div className={styles.menuItems}>
                    ...
                    <MenuCard
                        //@ts-ignore
                        url={MenuCards[0].url} title={MenuCards[0].title} img={MenuCards[0].img} />   <MenuCard
                        //@ts-ignore
                        url={MenuCards[0].url} title={MenuCards[0].title} img={MenuCards[0].img} />   <MenuCard
                        //@ts-ignore
                        url={MenuCards[0].url} title={MenuCards[0].title} img={MenuCards[0].img} />   <MenuCard
                        ...
                        url={MenuCards[0].url} title={MenuCards[0].title} img={MenuCards[0].img} />   <MenuCard
                        //@ts-ignore
                        url={MenuCards[0].url} title={MenuCards[0].title} img={MenuCards[0].img} />
