...
const PreferenceCard = ({description,title,color,id}:Props) => {
    ...
    return (
        <>
            <div className={classNames(styles.block, id === 2 ? styles.background2 : id === 3 ? styles.background3 : null)}>
                <span >{title} </span>
                <Flag id={id}/>
            </div>
            <div className={classNames(styles.block2, id === 2 ? styles.background2 : id === 3 ? styles.background3 : null)}>
